    ...
    <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"Focus on your work. We’ll handle the follow-ups."
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
        ...
        <motion.p
          ...
          Stay on top of clients, projects, and deadlines with smart automation.
            No more missed follow-ups, no more clutter — just smooth client management.
        </motion.p>
        <motion.div
          initial={{
            opacity: 0,
  ...
  return (
    <nav
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-base font-bold md:text-2xl text-white">FreelanceDesk</h1>
      </div>
      <button
